...
class DataExtractionHelper{  
  ...
  static setData(d: any){
    ...
    this.TARGET_BASSIN_ID = this.data["structureTarget"].indexOf("bassin");
    ...
    this.AGENTFINITION_RATIO_ID = this.data["structureAgentfinitions"].indexOf("ratioTargetedVisit");
