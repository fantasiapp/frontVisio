...
export class SimpleDonutsComponent extends GridArea {  
  constructor(private filtersService: FiltersStatesService, private sliceDice: SliceDice, private ref: ElementRef) {
    super();
  ...
  drawChart(): void {
    ...
    this.svg
      ...
      .enter()
      .append('path')
      .attr('d', d3.arc().innerRadius(radius / 2).outerRadius(radius+30))
